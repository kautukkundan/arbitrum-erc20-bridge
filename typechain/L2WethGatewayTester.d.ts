...
export class L2WethGatewayTester extends Contract {
  ...
  functions: {
    ...
    exitNum(overrides?: CallOverrides): Promise<{
      0: BigNumber;
    }>;
    ...
    l1Weth(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
    ...
    l2Weth(overrides?: CallOverrides): Promise<{
      0: string;
    }>;
