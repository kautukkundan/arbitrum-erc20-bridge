...
contract TestCustomTokenL1 is aeERC20, ICustomToken {
    ...
    function balanceOf(address account) public view override(ERC20Upgradeable, ICustomToken) returns (uint256) {
    ...
    function registerTokenOnL2(
        ...
        L1CustomGateway(bridge).registerTokenToL2(l2CustomTokenAddress, maxGas, gasPriceBid, maxSubmissionCost);
    }
}
