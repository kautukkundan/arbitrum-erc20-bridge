...
contract L2GatewayRouter is GatewayRouter {
    ...
    function setGateway(address[] memory _l1Token, address[] memory _gateway) external virtual onlyCounterpartGateway {
    ...
    function setDefaultGateway(address newL2DefaultGateway) external virtual onlyCounterpartGateway {
