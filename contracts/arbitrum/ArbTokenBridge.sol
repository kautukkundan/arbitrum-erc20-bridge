...
import "../ethereum/interfaces/IEthERC20Bridge.sol";
...
contract ArbTokenBridge is ProxySetter, IArbTokenBridge, TokenAddressHandler {
     ...
     */
    function customTokenRegistered(address l1Address, address l2Address) external override onlyEthPair {
    ...
    function _withdraw(
        ...
        uint256 id =
            ArbSys(address(0x0000000000000000000000000000000000000064)).sendTxToL1(
                ethTokenBridge,
                abi.encodeWithSelector(IEthERC20Bridge.withdrawFromL2.selector, exitNum, l1ERC20, destination, amount)
            );
        exitNum++;
    ...
    function migrate(
        ...
        require(TokenAddressHandler.isCustomToken(l1ERC20), "Needs to have custom token implementation");
        require(
    ...
    function calculateL2TokenAddress(address l1ERC20) public view override returns (address) {
        return TokenAddressHandler.calculateL2TokenAddress(l1ERC20, templateERC20, address(this), cloneableProxyHash);
    }
    ...
    function calculateL2ERC20TokenAddress(address l1ERC20) public view returns (address) {
        return
            TokenAddressHandler.calculateL2ERC20TokenAddress(l1ERC20, templateERC20, address(this), cloneableProxyHash);
    }
